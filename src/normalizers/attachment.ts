...
import { mergeDefined } from "src/utils/normalizers";
...
export const AttachmentRecord = ImmutableRecord({
  ...
  broadcaster: null as any, // TODO: Investigate
});
...
export const normalizeAttachment = (attachment: Record<string, any>) => {
  return AttachmentRecord(
    ImmutableMap(fromJS(attachment)).withMutations(
      (attachment: ImmutableMap<string, any>) => {
