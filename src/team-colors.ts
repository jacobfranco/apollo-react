...
const teamColorData: { [key: string]: ThemeColors } = {
  ...
  'EXILE esports Academy': { light: '#E74BCD', dark: '#E74BCD', logoType: 'color' },
  ...
  'Vikings Esports VN': { light: '#521E85', dark: '#521E85', logoType: 'white' },
  'Team Secret': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Fukuoka SoftBank Hawks gaming': { light: '#FBD001', dark: '#FBD001', logoType: 'black' },
