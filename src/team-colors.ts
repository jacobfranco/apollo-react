...
const teamColorData: { [key: string]: ThemeColors } = {
  ...
  'Forsaken': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Hanwha Life Esports': { light: '#F07122', dark: '#F07122', logoType: 'color' },
  ...
  'EXILE esports Academy': { light: '#26E6A0', dark: '#26E6A0', logoType: 'color' },
  'Maverix': { light: '#F24A01', dark: '#F24A01', logoType: 'color' },
  'Fly5': { light: '#000000', dark: '#FFFFFF', logoType: 'white' },
  'Juicy Ballers': { light: '#FEC48F', dark: '#FEC48F', logoType: 'color' },
  'Team Meliora': { light: '#00A2FE', dark: '#00A2FE', logoType: 'color' },
  'EXILE esports': { light: '#26E6A0', dark: '#26E6A0', logoType: 'color' },
  'Delta Syndicate': { light: '#E3237B', dark: '#E3237B', logoType: 'color' },
  'Ethereal Enigmas': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Esport STUBA': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Karmine Corp Blue': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Vitality.Bee': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'OGC Esports': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Team Liquid': { light: '#0A1723', dark: '#FFFFFF', logoType: 'black' },
  'Hurricane of Feathers': { light: '#4AC4FE', dark: '#4AC4FE', logoType: 'color' },
  ...
  'eQuizers': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Joker Strike': { light: '#A13A8E', dark: '#A13A8E', logoType: 'color' },
  'AvaTrade PixelPenny': { light: '#FDBF29', dark: '#FDBF29', logoType: 'color' },
  'Stormbringers': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Guasones': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Heracles Gaming': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'SK Gaming': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Rogue': { light: '#00B3F3', dark: '#00B3F3', logoType: 'color' },
  'Karmine Corp': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'GIANTX': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Team Vitality': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Team Heretics': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'BNK FearX Youth': { light: '#FCE502', dark: '#FCE502', logoType: 'color' },
  'DRX Challengers': { light: '#1203A3', dark: '#1203A3', logoType: 'color' },
  'ION Global Esports': { light: '#7E649B', dark: '#7E649B', logoType: 'color' },
  'FURY Global': { light: '#FE9A51', dark: '#FE9A51', logoType: 'color' },
  'Nongshim Esports Academy': { light: '#DC2527', dark: '#DC2527', logoType: 'color' },
  'Gen.G Global Academy': { light: '#866602', dark: '#866602', logoType: 'color' },
  'Dire Wolves': { light: '#00A982', dark: '#00A982', logoType: 'color' },
  'Team Bliss': { light: '#D56E91', dark: '#D56E91', logoType: 'color' },
  'KT Rolster Challengers': { light: '#FF0A07', dark: '#FF0A07', logoType: 'color' },
  'OKSavingsBank BRION Challengers': { light: '#004C29', dark: '#004C29', logoType: 'color' },
  'Kanga Esports': { light: '#FE6A00', dark: '#FE6A00', logoType: 'color' },
  'Ground Zero Gaming': { light: '#3D8968', dark: '#3D8968', logoType: 'color' },
  'Hanwha Life Esports Challengers': { light: '#F17321', dark: '#F17321', logoType: 'color' },
  'Dplus KIA Challengers': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Kwangdong Freecs Challengers': { light: '#EC3514', dark: '#EC3514', logoType: 'color' },
  'T1 Esports Academy': { light: '#EC012D', dark: '#EC012D', logoType: 'color' },
  ...
  'SK Gaming Prime': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'NNO Prime': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Ramboot Club': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Austrian Force willhaben': { light: '#D22F2E', dark: '#D22F2E', logoType: 'color' },
  'Eintracht Frankfurt': { light: '#CF0209', dark: '#CF0209', logoType: 'color' },
  'Team BDS Academy': { light: '#FE0073', dark: '#FE0073', logoType: 'color' },
  'Unicorns of Love Sexy Edition': { light: '#C25889', dark: '#C25889', logoType: 'color' },
  ...
  'Gentle Mates': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'MOUZ NXT': { light: '#FF0000', dark: '#FF0000', logoType: 'color' },
  'E WIE EINFACH E-SPORTS': { light: '#FF4593', dark: '#FF4593', logoType: 'black' },
  ...
  'GameWard': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'FC Schalke 04 Esports': { light: '#0060A9', dark: '#0060A9', logoType: 'color' },
  'BIG': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Leviatan': { light: '#6FB5EA', dark: '#6FB5EA', logoType: 'color' },
  'Six Karma': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'FearX': { light: '#FBE402', dark: '#FBE402', logoType: 'color' },
  'CTBC Flying Oyster': { light: '#FCD40D', dark: '#FCD40D', logoType: 'color' },
  'West Point Esports': { light: '#6E7AA8', dark: '#6E7AA8', logoType: 'color' },
  'Deep Cross Gaming': { light: '#0B5DC2', dark: '#0B5DC2', logoType: 'color' },
  'Burning Core Toyama': { light: '#125CA3', dark: '#125CA3', logoType: 'color' },
  ...
  'Vikings Esports VN': { light: '#000000', dark: '#FFFFFF', logoType: 'white' },
  'Team Secret': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Fukuoka SoftBank Hawks gaming': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'DetonatioN FocusMe': { light: '#2568FC', dark: '#2568FC', logoType: 'color' },
  ...
  'Shopify Rebellion': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Disguised': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Team Liquid Challengers': { light: '#0A1723', dark: '#FFFFFF', logoType: 'black' },
  ...
  'Royal Never Give Up': { light: '#B4926A', dark: '#B4926A', logoType: 'color' },
  ...
  'Venomcrest Esports': { light: '#ACDE07', dark: '#ACDE07', logoType: 'color' },
  'Anorthosis Famagusta Esports': { light: '#EF4E23', dark: '#EF4E23', logoType: 'color' },
  'Ruddy Esports': { light: '#731905', dark: '#731905', logoType: 'color' },
  'WLGaming Esports': { light: '#FF354E', dark: '#FF354E', logoType: 'color' },
  'ThunderTalk Gaming': { light: '#1FB3F2', dark: '#1FB3F2', logoType: 'color' },
  ...
  'Macko Esports': { light: '#000000', dark: '#FFFFFF', logoType: 'color' },
  'Papara SuperMassive': { light: '#B32C67', dark: '#B32C67', logoType: 'color' },
  ...
  'Odivelas Sports Club': { light: '##D8CF3E', dark: '#D8CF3E', logoType: 'color' },
  ...
  'NASR eSports Turkey': { light: '#F34236', dark: '#F34236', logoType: 'color' },
  ...
  'Lundqvist Lightside': { light: '#00DCE6', dark: '#00DCE6', logoType: 'color' },
  'Lupus Esports': { light: '#00C6AC', dark: '#00C6AC', logoType: 'color' },
  'Diamant Esports': { light: '#F17E02', dark: '#F17E02', logoType: 'color' },
  'SPIKE Syndicate': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'Crvena zvezda Esports': { light: '#EB2D2E', dark: '#EB2D2E', logoType: 'color' },
  'Misa Esports': { light: '#D6A646', dark: '#D6A646', logoType: 'color' },
  'Ultra Prime': { light: '#5081D5', dark: '#5081D5', logoType: 'color' },
  'Area of Effect Esports': { light: '#FED042', dark: '#FED042', logoType: 'color' },
  'Furia Academy': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'paiN Gaming Academy': { light: '#EF2C4B', dark: '#EF2C4B', logoType: 'color' },
  ...
  'Los Grandes Academy': { light: '#FF5D00', dark: '#FF5D00', logoType: 'color' },
  'Ankora Gaming': { light: '#ED671E', dark: '#ED671E', logoType: 'color' },
  'Cyber Wolves': { light: '#000000', dark: '#FFFFFF', logoType: 'black' },
  'KRC Genk Esports': { light: '#0065FE', dark: '#0065FE', logoType: 'color' },
  'Liberty Academy': { light: '#00E8E7', dark: '#00E8E7', logoType: 'color' },
  'Ultra Prime Academy': { light: '#5081D5', dark: '#5081D5', logoType: 'color' },
  'LNG Academy': { light: '#0395FF', dark: '#0395FF', logoType: 'color' },
  'Ji Jie Hao': { light: '#C93333', dark: '#C93333', logoType: 'color' },
  'FunPlus Phoenix Blaze': { light: '#FF0F00', dark: '#FF0F00', logoType: 'color' },
  'Bilibili Gaming Junior': { light: '#36CFF2', dark: '#36CFF2', logoType: 'color' },
  'Top Esports Challenger': { light: '#FE3D24', dark: '#FE3D24', logoType: 'color' },
  'LGD Gaming Young': { light: '#E4080E', dark: '#E4080E', logoType: 'color' },
  'MAX E-Sports Club': { light: '#64A7D3', dark: '#64A7D3', logoType: 'color' },
  'Invictus Gaming Young': { light: '#58C9F9', dark: '#58C9F9', logoType: 'color' },
  'OKSavingsBank BRION': { light: '#01492A', dark: '#01492A', logoType: 'color' },
  'Edward Gaming Youth Team': { light: '#87D249', dark: '#87D249', logoType: 'color' },
  ...
  'Winthrop University': { light: '#FFB80E', dark: '#FFB80E', logoType: 'color' },
  ...
  'Weibo Gaming Youth Team': { light: '#D22E2E', dark: '#D22E2E', logoType: 'color' },
  ...
  'Team Paradox': { light: '#000000', dark: '#FFFFFF', logoType: 'color' },
  ...
  'SAMCLAN Esports Club': { light: '#A21F1F', dark: '#A21F1F', logoType: 'color' },
  ...
  'Anyone\'s Legend.Young': { light: '#C22A2A', dark: '#C22A2A', logoType: 'color' },
  'ThunderTalk Gaming Young': { light: '#20B9F4', dark: '#20B9F4', logoType: 'color' },
...
export const useTeamColors = () => {
  ...
  const getTeamColorAndLogoType = (teamName: string): { color: string; logoType: 'black' | 'white' | 'color' } => {
