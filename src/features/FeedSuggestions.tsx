...
import { Card, CardBody, CardTitle, HStack, Stack, Text, VerificationBadge } from 'src/components';
      ...
      >
        <Stack space={3} className='mx-auto w-40 md:w-24'>
          ...
          <Stack>
            ...
            <Text theme='muted' align='center' size='sm' truncate>@{account.username}</Text>
          </Stack>
        </Stack>
      </Link>
