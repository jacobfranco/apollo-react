...
import { Spinner, Stack, StillImage, Text } from "src/components";
      ...
      <Stack space={10}>
        <div className="rounded-lg border border-solid border-gray-200 dark:border-gray-800">
          ...
          >
            ...
            {isSubmitting && (
              <div className="absolute inset-0 flex items-center justify-center rounded-t-md bg-white/80 dark:bg-primary-900/80">
            ...
            <button
              ...
              type="button"
              className={clsx({
                "absolute -top-3 -right-3 p-1 bg-primary-600 rounded-full ring-2 ring-white dark:ring-primary-900 hover:bg-primary-700":
                  true,
