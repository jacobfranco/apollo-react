...
import { ApolloConfig } from "src/types/apollo";

import type { Rgb, Hsl, TailwindColorPalette, TailwindColorObject } from 'src/types/colors';
...
export const generateThemeCss = (apolloConfig: ApolloConfig): string => {
    return colorsToCss(apolloConfig.colors.toJS() as TailwindColorPalette);
  };