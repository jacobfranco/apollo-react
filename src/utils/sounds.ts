import boopMp3 from 'src/assets/sounds/boop.mp3';
import boopOgg from 'src/assets/sounds/boop.ogg';
import chatMp3 from 'src/assets/sounds/chat.mp3';
import chatOgg from 'src/assets/sounds/chat.ogg';
