...
const unrepost =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      .post(`/api/statuses/${status.id}/unrepost`)
      .then(() => {
...
const toggleRepost = (status: StatusEntity) => (dispatch: AppDispatch) => {
  if (status.reposted) {
...
const like =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      .post(`/api/statuses/${status.id}/like`)
...
const unlike =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      .post(`/api/statuses/${status.id}/unlike`)
      .then(() => {
...
const toggleLike = (status: StatusEntity) => (dispatch: AppDispatch) => {
  if (status.liked) {
...
const bookmark =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    return api(getState)
      .post(`/api/statuses/${status.id}/bookmark`)
      .then((response) => response.json())
      .then((data) => {
...
const unbookmark =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      .post(`/api/statuses/${status.id}/unbookmark`)
      .then((response) => response.json())
      .then((data) => {
        dispatch(importFetchedStatus(data));
  ...
  (id: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      ...
      .then(async (response) => {
        ...
        dispatch(fetchRepostsSuccess(id, data, next));
      })
      .catch((error) => {
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    api(getState)
      ...
      .then(async (response) => {
        ...
        dispatch(importFetchedAccounts(data));
        dispatch(fetchRelationships(data.map((item: APIEntity) => item.id)));
        dispatch(expandRepostsSuccess(id, data, next));
      })
      .catch((error) => {
  ...
  (id: string) => (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      ...
      .then(async (response) => {
        ...
        dispatch(importFetchedAccounts(data));
        dispatch(fetchRelationships(data.map((item: APIEntity) => item.id)));
        dispatch(fetchLikesSuccess(id, data, next));
      })
      .catch((error) => {
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    api(getState)
      ...
      .then(async (response) => {
        ...
        dispatch(importFetchedAccounts(data));
        dispatch(fetchRelationships(data.map((item: APIEntity) => item.id)));
        dispatch(expandLikesSuccess(id, data, next));
      })
      .catch((error) => {
...
const pinToGroup =
  (status: StatusEntity, group: Group) =>
  (dispatch: AppDispatch, getState: () => RootState) => {
    return api(getState)
...
const unpin =
  ...
  (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    api(getState)
      .post(`/api/statuses/${status.id}/unpin`)
      .then((response) => response.json())
      .then((data) => {
        dispatch(importFetchedStatus(data));
