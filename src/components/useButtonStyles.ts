...
const themes = {
  ...
  accent:
    "border-transparent bg-secondary-500 dark:bg-secondary-700 hover:bg-secondary-700 dark:hover:bg-secondary-700 focus:bg-secondary-700 text-gray-100 focus:ring-secondary-300",
  danger:
  ...
  transparent:
    "border-transparent bg-transparent text-primary-600 dark:text-accent-blue dark:bg-transparent hover:bg-gray-200 dark:hover:bg-gray-800/50",
  outline:
    "border-gray-100 border-2 bg-transparent text-gray-100 hover:bg-white/10",
  muted:
...
const useButtonStyles = ({ theme, block, disabled, size }: IButtonStyles) => {
  const buttonStyle = clsx({
    "inline-flex items-center place-content-center border font-medium rounded-5px focus:outline-none focus:ring-2 focus:ring-offset-2 appearance-none transition-all":
      true,
