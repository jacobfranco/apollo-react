...
const themes = {
  primary:
    'bg-primary-500 hover:bg-primary-400 dark:hover:bg-primary-600 border-transparent focus:bg-primary-500 text-gray-100 dark:text-accent-500 focus:ring-primary-300',
  secondary:
    'border-primary-500 bg-primary-100 dark:bg-accent-500 hover:bg-primary-50 dark:hover:bg-primary-900 focus:bg-primary-100 dark:focus:bg-primary-800 text-primary-500 dark:text-primary-500',
  tertiary:
...
const useButtonStyles = ({
  ...
  const buttonStyle = clsx({
    'inline-flex items-center place-content-center border font-medium rounded-5px focus:outline-none focus:ring-2 focus:ring-offset-2 appearance-none transition-all': true,
