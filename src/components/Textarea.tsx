    ...
    return (
      <Stack space={1.5}>
        <textarea
          ...
          className={clsx(
            "block w-full rounded-md text-gray-900 placeholder:text-gray-600 sm:text-sm dark:text-gray-100 dark:placeholder:text-gray-600",
            {
          ...
          dir={
            value?.length
              ? getTextDirection(value, { fallback: locale.direction })
              : undefined
          }
        />
