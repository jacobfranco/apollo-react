...
import { HStack, PlaceholderAvatar, PlaceholderDisplayName, PlaceholderStatusContent } from 'src/components';
...
const PlaceholderStatus: React.FC<IPlaceholderStatus> = ({ variant }) => (
  <div
    className={clsx({
      'status-placeholder bg-white dark:bg-accent-800': true,
