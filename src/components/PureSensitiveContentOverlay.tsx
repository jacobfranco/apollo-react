...
const messages = defineMessages({
  ...
  underReviewTitle: {
    id: "moderation_overlay.title",
    defaultMessage: "Content Under Review",
  },
  underReviewSubtitle: {
    id: "moderation_overlay.subtitle",
    defaultMessage:
      "This Post has been sent to Moderation for review and is only visible to you. If you believe this is an error please contact Support.",
  },
  sensitiveSubtitle: {
...
const PureSensitiveContentOverlay = forwardRef<
  HTMLDivElement,
  IPureSensitiveContentOverlay
>((props, ref) => {
          ...
          <div className="mx-auto w-3/4 space-y-4 text-center" ref={ref}>
            <div className="space-y-1">
              <Text theme="white" weight="semibold">
                {intl.formatMessage(
                  isUnderReview
                    ? messages.underReviewTitle
                    : messages.sensitiveTitle
                )}
              </Text>
            ...
            <HStack alignItems="center" justifyContent="center" space={2}>
              ...
              {isUnderReview && isOwnStatus ? (
                <DropdownMenu items={menu} src={dotsIcon} />
              ) : null}
            </HStack>
          </div>
        </div>
