  ...
  (
    ...
    return (
      <button
        ...
        type="button"
        className={clsx(
          "flex items-center space-x-2 rounded-full p-1 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:ring-offset-0",
          {
            "bg-transparent": theme === "seamless",
